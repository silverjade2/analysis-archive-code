"""Site visual tone for figures (Pretendard, site palette, webp) — shared by 08 and 10."""
import io
...
# feature id → Korean label (same mapping as the article's interactive widget)
NAMES = {
...
# features that are (mostly) consequences of the target — activity after consent
...
# the planted drivers of consent
