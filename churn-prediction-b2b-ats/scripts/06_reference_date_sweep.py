"""기준일 sweep. 라벨의 "오늘"을 움직이면 같은 회사의 라벨이 얼마나 바뀌는가.

live는 그 시점까지 체결된 계약으로 라벨을 만든다. 노트북을 나중에 새 데이터로 다시 돌린 경우다. frozen은
2024-02 스냅샷을 그대로 두고 today만 바뀐 경우다. 데이터 갱신 없이 재실행한 것이다.
"""
